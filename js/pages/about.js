...
document.getElementById("main-root").innerHTML = `
  ...
  <!-- ── HERO ── -->
  <section id="hero" style="background:#111;color:#fff;padding:calc(var(--hdr) + var(--banner) + 48px) 24px 72px;">
  ...
  <div style="max-width:900px;margin:0 auto;padding:72px 24px 96px;">
    ...
    <div style="margin-bottom:96px;">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px;">
        ${featureCard(
          ...
          "Patent Pending",
          "Unique design protected by Canadian and US intellectual property law.",
        )}
        ${featureCard(
    ...
    <div style="text-align:center;padding:56px 32px;background:#111;border-radius:24px;color:#fff;">
      ...
      <p style="font-size:0.92rem;color:rgba(255,255,255,0.55);max-width:420px;margin:0 auto 28px;line-height:1.7;">Get your OHD Kit Now. Free Canada-wide shipping.</p>
