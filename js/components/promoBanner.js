...
const PROMOS = [
  ...
  {
    enabled: true,
    text: "SALE - 20% off all OHD Kits. Use code FGDS20",
...
const SHIP =
  '<svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 4v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>';
const STAR =
  '<svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24" width="24" height="24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27z" fill="none"/></svg>';
const HEART =
...
function PromoBannerHTML() {
  ...
  return `<div id="promo-banner" class="pulse-text" role="region" aria-label="Promotions">${items}</div>`;
}
